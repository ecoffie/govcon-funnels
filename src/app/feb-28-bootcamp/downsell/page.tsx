...
export default function Feb28Downsell() {
  return (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-slate-500 leading-relaxed">
              Not ready for Pro? Our <span className="text-blue-400 font-semibold">Starter Plan</span> gives you essential tools and resources at a fraction of the cost.
            </p>
          </div>
          ...
          <div className="bg-slate-900 border-2 border-blue-500 rounded-2xl p-8 mb-8 relative">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-slate-500">Perfect for beginners who want more than free resources</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <ul className="space-y-3 text-slate-400">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-blue-500 mt-1">✓</span>
                  <span>Email Script Templates</span>
                </li>
              </ul>
              <ul className="space-y-3 text-slate-400">
                <li className="flex items-start gap-2">
