...
export default function FreeCourseDownsell() {
  return (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="text-slate-400">
                  ...
                  <tr className="border-b border-slate-800">
                    <td className="py-2">Certifications Training</td>
                    <td className="text-center text-slate-600">✗</td>
                    <td className="text-center text-blue-400">✓</td>
                    <td className="text-center text-green-500">✓</td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <td className="py-2">Community Access</td>
                    <td className="text-center text-slate-600">✗</td>
                    <td className="text-center text-blue-400">✓</td>
                    <td className="text-center text-green-500">✓</td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <td className="py-2">Pro Member Group</td>
                    <td className="text-center text-slate-600">✗</td>
                    <td className="text-center text-slate-600">✗</td>
                    <td className="text-center text-green-500">✓</td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <td className="py-2">Bootcamp & Webinar Replays</td>
                    <td className="text-center text-slate-600">✗</td>
                    <td className="text-center text-slate-600">✗</td>
                    <td className="text-center text-green-500">✓</td>
                  </tr>
