...
export const metadata: Metadata = {
  ...
  description: 'Get everything you need to win federal contracts consistently with Pro membership.',
};

export default function OppDownsell() {
  return (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Wait! Here&apos;s <span className="text-green-500">Another Option</span>
            </h1>

            <p className="text-xl text-slate-500 leading-relaxed">
              Not ready to buy? Join our <span className="text-green-500 font-semibold">Pro Member Group</span> instead and get Opportunity Hunter Pro included!
            </p>
          </div>
          ...
          <div className="bg-gradient-to-b from-slate-900/50 to-slate-800 border-2 border-green-600 rounded-2xl p-8 mb-8 relative">
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
              <span className="green-glow bg-green-600 text-white text-xs font-bold px-3 py-1 rounded-full">BEST VALUE</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <ul className="space-y-3 text-slate-400">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Opportunity Hunter Pro</strong> Included!</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-600 mt-1">✓</span>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 mb-8">
            <h3 className="text-lg font-bold text-white mb-4 text-center">Why Pro is Better Value</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-800">
                    <th className="text-left text-slate-400 py-2">Feature</th>
                    <th className="text-center text-slate-400 py-2">OH Pro ($49)</th>
                    <th className="text-center text-green-500 py-2">Pro Member ($99/mo)</th>
                  </tr>
                </thead>
                <tbody className="text-slate-400">
                  ...
                  <tr className="border-b border-slate-800">
                    <td className="py-2">Mini Courses & Webinars</td>
                    <td className="text-center text-slate-600">✗</td>
                    <td className="text-center text-green-500">✓</td>
                  </tr>
                  <tr className="border-b border-slate-800">
                    <td className="py-2">Community Support</td>
                    <td className="text-center text-slate-600">✗</td>
                    <td className="text-center text-green-500">✓</td>
                  </tr>
                </tbody>
          ...
          <div className="text-center">
            ...
            >
              No thanks, just give me the free tool →
            </Link>
          </div>
