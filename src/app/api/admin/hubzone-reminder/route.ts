...
export async function GET(request: NextRequest) {
  ...
  // Admin password ONLY. The shareable HUBZone tracker password gates read-only
  // registration viewing (/api/hubzone/registrations); it must NOT be able to
  // trigger reminder email sends. Sends require the full admin secret.
  ...
  try {
    ...
    //   ?preview=recording&to=you@email.com  (recording + Mindy Aug 22 + contacts)
