...
const downloads = [
  { num: 1, title: 'March 2026 Expiring Contracts List', desc: '15 sample contracts from 944 expiring in March 2026', file: '/march-surge/downloads/march-2026-expiring-contracts.html', label: 'View List', source: 'Recompete Tracker', sourceDesc: 'Get the full tracker with 6,900+ expiring contracts across 36 agencies', sourceUrl: 'https://shop.govcongiants.com/expiring-contracts', sourceLabel: 'Get Full Tracker - $397' },
  { num: 2, title: 'Recompete Positioning Checklist', desc: '18-month timeline for recompetes', file: '/march-surge/downloads/recompete-positioning-checklist.html', label: 'View Checklist', source: 'Recompete Tracker', sourceDesc: 'Filter by NAICS, agency, value & track 6,900+ contracts', sourceUrl: 'https://shop.govcongiants.com/expiring-contracts', sourceLabel: 'Get Full Tracker - $397' },
  { num: 3, title: '10 IDIQ Vehicles Guide', desc: 'The most active GWAC/IDIQ vehicles', file: '/march-surge/downloads/10-idiq-vehicles-guide.html', label: 'View Guide', source: 'The Vault', sourceDesc: '125+ premium GovCon templates, proposals & guides', sourceUrl: 'https://shop.govcongiants.com', sourceLabel: 'Access The Vault (Pro)' },
  { num: 4, title: 'Active IDIQ Vehicles List', desc: '50 vehicles with ceiling values & NAICS', file: '/march-surge/downloads/active-idiq-vehicles-list.html', label: 'View List', source: 'Recompete Tracker', sourceDesc: 'Full database with ceiling values, ordering agencies & task orders', sourceUrl: 'https://shop.govcongiants.com/expiring-contracts', sourceLabel: 'Get Full Tracker - $397' },
  { num: 5, title: 'Sources Sought Response Template', desc: 'Fill-in-the-blank template', file: '/march-surge/downloads/sources-sought-response-template.html', label: 'View Template', source: 'The Vault', sourceDesc: '125+ premium templates including proposals, contracts & bid forms', sourceUrl: 'https://shop.govcongiants.com', sourceLabel: 'Access The Vault (Pro)' },
  { num: 6, title: 'Task Order Response Template', desc: 'Framework for IDIQ task orders', file: '/march-surge/downloads/task-order-response-template.html', label: 'View Template', source: 'GovCon Shop', sourceDesc: 'Professional proposal templates, databases & contractor tools', sourceUrl: 'https://shop.govcongiants.com', sourceLabel: 'Browse All Products' },
];
