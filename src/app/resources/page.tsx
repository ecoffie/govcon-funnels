...
export default function ResourceLibrary() {
  ...
  return (
    <main className="min-h-screen bg-slate-950">
      {/* Header */}
      <header className="py-6 px-6 border-b border-slate-800 sticky top-0 bg-slate-950/95 backdrop-blur z-50">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <a
            ...
            className="hidden sm:inline-flex px-4 py-2 bg-green-600 hover:bg-green-500 text-white rounded-lg font-semibold text-sm transition"
          >
            Upgrade to Pro
          </a>
        </div>
