...
export default function SurgeUpsell() {
  return (
      ...
      <div className="bg-slate-900 py-3 px-6 border-b border-slate-800">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="h-2 bg-slate-700 rounded-full overflow-hidden">
            <div className="h-full green-glow bg-green-600 rounded-full" style={{ width: '50%' }}></div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-slate-500 leading-relaxed">
              The free resources are great for getting started. But our <span className="text-green-500 font-semibold">Pro Members</span> get live training, expert support, and exclusive tools to win contracts consistently.
            </p>
          </div>
