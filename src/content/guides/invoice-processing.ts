  ...
  sections: [
    ...
    },
    {
      ...
      content: `
        ...
        <p>Even a clean invoice still pays on Net-30 to Net-90. To bridge that gap, <a href="${FUNDING_DEST}" rel="noopener">government invoice factoring</a> advances most of the invoice value in days instead of weeks.</p>
      `,
    },
    {
