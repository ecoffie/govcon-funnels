...
import { BOOTCAMP_DATE_ISO } from './mindy-day';
...
/** The shared Mindy Day config drives the countdown + pace math and public
 *  SiteNav label. Saturday, August 22, 2026 · 10 AM–1 PM ET.
