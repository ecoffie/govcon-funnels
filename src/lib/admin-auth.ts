 ...
 * Accepts the password via `x-admin-password` header or
 * `Authorization: Bearer <pw>`. Set PURCHASES_ADMIN_PASSWORD in the
 * environment; falls back to ADMIN_PASSWORD if unset.
 */
export const ADMIN_COOKIE = "gca_purchases_admin";
