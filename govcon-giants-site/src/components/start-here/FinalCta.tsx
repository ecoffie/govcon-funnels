      ...
      <div className="container-gg relative">
        <div className="relative mx-auto max-w-[640px] text-center">
          <motion.img
            ...
            className="mx-auto mb-8 w-[140px] animate-float-y rounded-lg shadow-[0_20px_50px_rgba(0,0,0,0.5)] lg:absolute lg:-left-56 lg:top-1/2 lg:mb-0 lg:-translate-y-1/2"
          />
