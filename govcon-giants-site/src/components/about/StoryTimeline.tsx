            ...
            <div className="relative h-16 w-32" aria-live="polite">
              {beats.map((b) => (
                <span
                  key={b.marker}
                  data-year
                  className="absolute inset-0 flex items-center font-display text-[40px] font-black text-brand tabular-nums"
                >
                  {b.marker}
                </span>
              ))}
            ...
            <div ref={stageRef} className="relative space-y-12 lg:h-[60vh] lg:space-y-0">
              {beats.map((b) => (
                ...
                >
                  ...
                  <h3 className="mb-4 font-display text-[28px] font-extrabold leading-[1.2] tracking-tight text-slate-900">
                    {b.title}
                  </h3>
                  <p className="max-w-[520px] text-base leading-[1.7] text-slate-600">
                    {b.body}
                  </p>
                </article>
              ))}
