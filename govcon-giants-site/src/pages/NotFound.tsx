...
export default function NotFound() {
  ...
  return (
    <div className="container-gg py-28 text-center">
      ...
      <h1 className="mb-4 font-display text-4xl font-extrabold tracking-tight text-slate-900">
        That page doesn&apos;t exist.
      </h1>
      <p className="mx-auto mb-8 max-w-md text-[16px] leading-relaxed text-slate-600">
